...
def multiply(num): # Створення функції 'multiplay' , яка виконує наступні дії :
    print(num * 2) # Множить введене число на 2

multiply(3) # Застосування функції 'multiplay'
...
with open('text.txt', 'w') as tp:
    print('New Line', file=tp)
